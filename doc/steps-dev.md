...
| step21 | ✅ 完成 | Frontend + Backend | - | doc/plans/step21-安装vitest测试框架_ce07c06d.plan.md | - |
| step2 | ⬜ 待开始 | Frontend（UI） | - | - | - |
| step3 | ⬜ 待开始 | Frontend（UI） | - | - | - |
| step4 | ⬜ 待开始 | Frontend | - | - | - |
| step5 | ⬜ 待开始 | Frontend（UI） | - | - | - |
| step6 | ✅ 完成 | Backend | - | doc/plans/step1-plan.md | - |
| step7 | ⬜ 待开始 | Backend | - | doc/plans/step7-plan.md | - |
| step8 | ⬜ 待开始 | Backend | - | - | - |
| step9 | ⬜ 待开始 | Backend | - | - | - |
| step10 | ⬜ 待开始 | Backend | - | - | - |
| step11 | ⬜ 待开始 | Backend | - | - | - |
| step12 | ⬜ 待开始 | Frontend（集成） | - | - | - |
| step13 | ⬜ 待开始 | Backend | - | - | - |
| step14 | ⬜ 待开始 | Backend | - | - | - |
| step15 | ⬜ 待开始 | Backend | - | - | - |
| step16 | ⬜ 待开始 | Backend | - | - | - |
...
| 角色 | 负责的 step |
|------|-------------|
| Backend | step0、step6～step11、step13～step20 |
